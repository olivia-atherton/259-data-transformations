...
- In dplyr functions, the data argument lets you work with column names without ever using `$`. The data argument also lets you access the columns directly without using quoted expressions
...
---
`r chunk_reveal("mutate", break_type = "auto", float = "none", widths = c(3, 1), title = "# Mutate (add or modify columns)")`

```{r mutate, include = FALSE}
ds <- starwars %>% select(name, mass, height, species) #omit
