...
- Code can automate data transfer/data processing without human input
...
- A toolbox for common data processing/manipulation operations to apply to tibbles
  ...
  * `summarize()` to calculate summary statistics over rows of data
...
<!-- adjust font size in this css code chunk -->
